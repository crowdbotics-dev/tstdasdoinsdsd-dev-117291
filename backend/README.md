...
## Project Structure
    ...
    ├── tstdasdoinsdsd_dev_117291  # Django project configurations
...
1. Clone this repo and `cd tstdasdoinsdsd_dev_117291`
...
2. Clone this repo and `cd tstdasdoinsdsd_dev_117291`
